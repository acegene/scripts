# Quickly clear or edit the file explorer quick access menu of unpinned entries
#
# usage
#   * set-quick-access.ps1 -clear
#       * removes all unpinned entires from quick access
#
# warnings
#   * file explorer is force reloaded during the clear process
#
# todos
#   * enable editing of quick-access entries, see: https://gallery.technet.microsoft.com/Set-QuickAccess-117e9a89
